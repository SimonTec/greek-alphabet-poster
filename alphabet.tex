...
% clasic, schnaubelt, dark
\newcommand{\colorSchem}			{clasic}
...
\newcommand{\useSelectetColorSchema}{
	\ifthenelse{\equal{\colorSchem}{clasic}}{
...
\newcommand{\drawBackground}{
	\FPeval{\backWidth}{columns * (boxWidth + padding) + padding}
	\FPeval{\backHeight}{\intcalcDiv{24}{\columns} * (boxHeight + padding) + 2 * padding + headerHeight}
	
	\fill [colorBackground] (0,0) +(0,-\padding) rectangle (\backWidth ,\backHeight);
